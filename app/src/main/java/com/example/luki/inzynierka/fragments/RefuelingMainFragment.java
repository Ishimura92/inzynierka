...
@EFragment(R.layout.fragment_refueling_main)
public class RefuelingMainFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_refueling_main, container, false);
